...
[
	...
	new Road("../static/images/road.jpg", canvas.width)
]; //Backgrounds

var player = new Car("../static/images/car.png", canvas.width / 2, canvas.height / 2, true); //Player's object
...
function Update() 
{
	...
	{
		objects.push(new Car("../static/images/car_red.png", RandomInteger(30, canvas.width - 50), RandomInteger(250, 400) * -1, false));
	}
